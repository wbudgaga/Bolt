...
public final class MurmurHash3 {
  ...
  public static final LongPair out 	= new LongPair();
  ...
  public static void murmurhash3_x64_128(byte[] key, int offset, int len, int seed, LongPair out) {
    ...
    for (int i				= offset; i<roundedEnd; i+=16) {
        ...
        k1 				*= c1; 
	k1  				= Long.rotateLeft(k1,31); k1 *= c2; h1 ^= k1;
  ...
  public static long hash32(final long data) {
	  byte[] bytes 			= ByteStream.longToByteArray(data);  
	  return murmurhash3_x86_32 ( bytes,0, bytes.length, seed);
  }
  public static long hash32(final String data) { 
	  byte[] bytes 			= data.getBytes();
	  return murmurhash3_x86_32 ( bytes,0, bytes.length, seed);
  }
  
	public static long hash128Low(final long data) {
		byte[] bytes 		= ByteStream.longToByteArray(data);
		synchronized(LOCK){
			murmurhash3_x64_128( bytes,0, bytes.length, seed,out);
			return out.val1;
		}
	}
	public static long hash128Low(final String data) {
		byte[] bytes 		= data.getBytes();
		synchronized(LOCK){
			murmurhash3_x64_128( bytes,0, bytes.length, seed,out);
			return out.val1;
...
public static void main(String args[]){
	System.out.println(hash32(23));
/*	  byte[] bytes= ByteStream.longToByteArray(23l);
...
//	  System.out.println(lp.val1+"  "+lp.val2);
  }
}
